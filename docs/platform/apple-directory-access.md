...
The document picker grants user-selected directories only. Covalent persists permitted bookmarks where the provider supports them, coordinates access, and designs transfers to resume after suspension. Background tasks are opportunistic and bounded by iOS. The app does not access other apps' private data and does not claim full-device backup.
