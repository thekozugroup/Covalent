...
| Android native | Tier 1 blocker | `./scripts/check-android.sh` against API 37 | Unit, Compose UI, instrumentation, SAF revocation, opt-in local-network permission, process death/resume, accessibility, release candidate. |
