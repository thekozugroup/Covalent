...
android_build_inputs="apps/android crates packaging/sync-engine Cargo.toml Cargo.lock rust-toolchain.toml scripts/build-android-jni.sh scripts/build-android-sync-engine.sh scripts/android-native-budgets.sh scripts/check-android-native-package.sh scripts/test-android-native-package.sh"
