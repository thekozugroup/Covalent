...
require_text "golang.org/x/crypto v0.56.0" "$caddy_gomod"
require_text "x/crypto drifted from reviewed v0.56.0" "$dockerfile"
...
require_text 'bind unix//config/covalent-web.sock|0600' "$repo_root/packaging/docker/Caddyfile"
require_text 'tailscale serve --bg --https=8443' "$documentation"
require_text 'do not use Tailscale Funnel' "$documentation"
